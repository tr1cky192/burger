...
<section class="main">
    <section class="main-content">
        <div class="container">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/main_burger.png" alt="Big burger" class="main-images">
        </div>
    </section>
...
<section class="why" id="why">
    <div class="container">
        ...
        <div class="why-items">
            <div class="why-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/burger.png" alt="burger" class="why-item-img">
            ...
            <div class="why-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meat.png" alt="meat" class="why-item-img">
            ...
            <div class="why-item">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/food%20truck.png" alt="food truck" class="why-item-img">
    ...
    <div class="container">
        ...
        <div class="products-items">
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%201.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%202.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%203.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%204.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%205.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Burger%206.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/7.png" alt="burger"></div>
                <div class="products-item-title">Вегги бургер</div>
                <div class="products-item-text">Булочка для бургера, вегетарианская котлета, красный лук, сыр, свежий
                    томат, соус барбекю, соус сырный, салат айсберг
                </div>
                <div class="products-item-extra">
                    <div class="products-item-info">
                        <div class="products-item-price" data-base-price="8">8 $</div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/8.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/9.png" alt="burger"></div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/10.png" alt="burger"></div>
                <div class="products-item-title">Фрешбургер</div>
                <div class="products-item-text">Булочка для бургера, говяжья котлета, бекон, сыр чеддар, яйцо, салями,
                    соус барбекю, соус сырный, салат айсберг, свежий томат
                </div>
                <div class="products-item-extra">
                    <div class="products-item-info">
                        <div class="products-item-price" data-base-price="9">9 $</div>
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/11.png" alt="burger"></div>
                <div class="products-item-title">Цуккини бургер</div>
                <div class="products-item-text">Булочка для бургера, вегетарианская котлета из нута, цуккини на гриле,
            ...
            <div class="products-item">
                <div class="products-item-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/12.png" alt="burger"></div>
...
<section class="order" id="order">
    <div class="container">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/order_image.png" alt="burger in the box" class="order-img">
        <div class="order-form">
            <div class="order-form-text">Заполните все данные и наш менеджер свяжется с вами для подтверждения заказ
            </div>
            <div class="order-form-inputs">
                ...
                <div class="order-form-input" id="phone">
